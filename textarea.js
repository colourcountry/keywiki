...
/*
    This is the unicode alphabetic character range according to user1934618's answer to http://stackoverflow.com/questions/150033
    ...
    for now I'll use this much easier range also in that answer

    Bug #6: added hyphen
*/
WORD_MATCH_REGEX = /^([<>_-\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/;
SPACE_MATCH_REGEX = /([<>_-\u00C0-\u1FFF\u2C00-\uD7FF\w]+)\s*$/;
...
var get_current_word = function(textarea) {
    ...
    var space_match = WORD_MATCH_REGEX.exec(textarea.value.slice(textarea.selectionEnd));
    if (space_match) {
    ...
    var match = SPACE_MATCH_REGEX.exec(slice);
